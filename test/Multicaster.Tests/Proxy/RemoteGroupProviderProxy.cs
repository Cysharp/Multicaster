...
namespace Multicaster.Tests
{
    ...
    partial struct RemoteGroupProviderProxy
    {

        global::Cysharp.Runtime.Multicast.Remoting.RemoteGroupProvider target;

        public RemoteGroupProviderProxy(global::Cysharp.Runtime.Multicast.Remoting.RemoteGroupProvider target)
        {
            this.target = target;
        }
    ...
    {
        public static global::Multicaster.Tests.RemoteGroupProviderProxy AsPrivateProxy(this global::Cysharp.Runtime.Multicast.Remoting.RemoteGroupProvider target)
        {
            return new global::Multicaster.Tests.RemoteGroupProviderProxy(target);
        }
    }
